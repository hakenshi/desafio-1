...
export abstract class ProductService {
  ...
  static async getAll(query?: ProductModel.GetAllProductsQuery): Promise<ProductModel.Product[]> {
    "use cache";
    cacheTag(ProductService.CACHE_TAGS.products);
    cacheLife("minutes");
  ...
  static async getById(id: string): Promise<ProductModel.Product> {
    "use cache";
    cacheTag(ProductService.CACHE_TAGS.product(id));
    cacheLife("hours");
  ...
  static async search(query: ProductModel.SearchProductsQuery): Promise<ProductModel.Product[]> {
    "use cache";
    cacheTag(ProductService.CACHE_TAGS.search);
    cacheLife("minutes");
  ...
  static async getLowStock(): Promise<ProductModel.Product[]> {
    "use cache";
    cacheTag(ProductService.CACHE_TAGS.lowStock);
    cacheLife("seconds");
  ...
  static async create(data: ProductModel.CreateProductDto): Promise<ProductModel.Product> {
    ...
    const product = ProductModel.ProductSchema.parse(response);

    revalidateTag(ProductService.CACHE_TAGS.products, "max");
    revalidateTag(ProductService.CACHE_TAGS.lowStock, "max");
    revalidateTag(ProductService.CACHE_TAGS.search, "max");
  ...
  static async update(id: string, data: ProductModel.UpdateProductDto): Promise<ProductModel.Product> {
    ...
    revalidateTag(ProductService.CACHE_TAGS.product(id), "max");
    revalidateTag(ProductService.CACHE_TAGS.products, "max");
    revalidateTag(ProductService.CACHE_TAGS.lowStock, "max");
    revalidateTag(ProductService.CACHE_TAGS.search, "max");
